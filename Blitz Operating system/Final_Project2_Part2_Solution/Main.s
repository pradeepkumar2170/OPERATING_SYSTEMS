...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: not_full = zeros  (sizeInBytes=16)
	load	[r14+8],r4
	add	r4,28,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: not_empty = zeros  (sizeInBytes=16)
	load	[r14+8],r4
	add	r4,44,r4
	store	r0,[r4]
	store	r0,[r4+4]
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_597:
!   if bufferLength != 5 then goto _Label_599		(int)
	load	[r14+8],r1
	load	[r1+24],r1
	mov	5,r2
	cmp	r1,r2
...
!   _temp_602 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-76]
!   Move address of _temp_602 [bufferNextIn ] into _temp_603
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+16],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-72]
!   Data Move: *_temp_603 = c  (sizeInBytes=1)
	loadb	[r14+12],r1
	load	[r14+-72],r2
	storeb	r1,[r2]
! ASSIGNMENT STATEMENT...
...
!   _temp_604 = bufferNextIn + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-68]
!   bufferNextIn = _temp_604 rem 5		(int)
	load	[r14+-68],r1
	mov	5,r2
	cmp	r2,0
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if bufferLength <= 0 then goto _Label_606		(int)
	load	[r14+8],r1
	load	[r1+24],r1
	mov	0,r2
	cmp	r1,r2
...
!   if intIsZero (_P_Thread_currentThread) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   _temp_611 = _P_Thread_currentThread + 72
	set	_P_Thread_currentThread,r1
	load	[r1],r1
	add	r1,72,r1
	store	r1,[r14+-48]
...
!   _temp_616 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_617 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_619 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_619 [j ] into _temp_620
!     make sure index expr is >= 0
	load	[r14+-96],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_618 = *_temp_620  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_618  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_655:
!   if intIsZero (bufferLength) then goto _Label_656
	load	[r14+8],r1
	load	[r1+24],r1
	cmp	r1,r0
	be	_Label_656
...
!   _temp_660 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-76]
!   Move address of _temp_660 [bufferNextOut ] into _temp_661
!     make sure index expr is >= 0
	load	[r14+8],r2
	load	[r2+20],r2
	cmp	r2,0
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-72]
!   Data Move: c = *_temp_661  (sizeInBytes=1)
	load	[r14+-72],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
! ASSIGNMENT STATEMENT...
...
!   _temp_662 = bufferNextOut + 1		(int)
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-68]
!   bufferNextOut = _temp_662 rem 5		(int)
	load	[r14+-68],r1
	mov	5,r2
	cmp	r2,0
	be	_runtimeErrorZeroDivide
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if bufferLength >= 5 then goto _Label_664		(int)
	load	[r14+8],r1
	load	[r1+24],r1
	mov	5,r2
	cmp	r1,r2
...
!   _temp_674 = 1		(4 bytes)
	...
	store	r1,[r14+-44]
!   Calculate and save the FOR-LOOP ending value
!   _temp_675 = bufferLength		(4 bytes)
	load	[r14+8],r1
	load	[r1+24],r1
	store	r1,[r14+-40]
!   Initialize FOR-LOOP index variable
...
!   _temp_677 = &buffer
	...
	add	r1,4,r1
	store	r1,[r14+-36]
!   Move address of _temp_677 [j ] into _temp_678
!     make sure index expr is >= 0
	load	[r14+-96],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-32]
!   Data Move: _temp_676 = *_temp_678  (sizeInBytes=1)
	load	[r14+-32],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
!   Prepare Argument: offset=8  value=_temp_676  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+0]
!   Call the function
...
!   _temp_685 = 5 - bufferLength		(int)
	...
	store	r1,[r14+-20]
!   Initialize FOR-LOOP index variable
!   Data Move: i = _temp_684  (sizeInBytes=4)
	load	[r14+-24],r1
	store	r1,[r14+-92]
_Label_680:
!   Perform the FOR-LOOP termination test
!   if i > _temp_685 then goto _Label_683		
	load	[r14+-92],r1
	load	[r14+-20],r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
